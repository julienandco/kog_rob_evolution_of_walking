from simulation import Simulation, Figure
...
class GeneticAlgorithm:
    def __init__(
        ...
        self.individual_size = self.sim_runtime * moves_per_second  # number of actions in one simulation
